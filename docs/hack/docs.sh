...
sphinx-apidoc -f -e -o docs/source/apidoc/ disaster/
...
sed -i.bak '0,/disaster/s//API/' docs/source/apidoc/modules.rst
# Show package's name in the home page
sed -i.bak '0,/project/s//disaster/' docs/source/index.rst
# Delete backup files
