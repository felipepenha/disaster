...
class BertEmbedding(object):
    ...
    batch_size : int, default 256
        batch size
    root : str,
        default '$MXNET_HOME/models' with MXNET_HOME defaults to '~/.mxnet'
    ...
    def embedding(self, sentences, oov_way='avg'):
        ...
        oov_way : str, default avg.
            use **avg**, **sum** or **last** to get token
            embedding for those out of vocabulary words
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help=(
            'how to handle oov\n' +
            'avg: average all oov embeddings' +
                'to represent the original token\n' +
            'sum: sum all oov embeddings to represent' +
                'the original token\n' +
            'last: use last oov embeddings to represent' +
                'the original token\n'
            )
        )
    parser.add_argument(
